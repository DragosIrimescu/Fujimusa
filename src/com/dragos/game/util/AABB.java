package com.dragos.game.util;

import com.dragos.game.entity.Entity;
import com.dragos.game.tiles.TileMap;
import com.dragos.game.tiles.TileMapObj;
...
public class AABB {
    ...
    public float getHetight() {return h;}
    ...
    public boolean colCircleBox(AABB aBox) {
        ...
        float yDelta = cy - Math.max(aBox.pos.getWorldVar().y + (aBox.getHetight() / 2), Math.min(cx,aBox.pos.getWorldVar().y));
    ...
    public boolean collisionTile(float ax, float ay) {
        for (int c = 0; c < 4; c++)
        {
            ...
            int yt = (int) ( (pos.x + ay) + ((int) (c / 2)) * h + yOffset) / 64;
